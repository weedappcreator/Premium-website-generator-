...
/* ── Design Direction: Food & Beverage (#55) with Taconazo24 neon pink ── */
const C = {
  bg:       "oklch(0.96 0.01 80)",       /* warm cream   */
  surface:  "oklch(0.94 0.012 75)",
  fg:       "oklch(0.25 0.02 70)",       /* dark brown   */
  muted:    "oklch(0.55 0.02 70)",
  border:   "oklch(0.82 0.015 75)",
  accent:   "oklch(0.6 0.25 350)",       /* neon pink    */
  dark:     "oklch(0.15 0.015 70)",      /* warm dark    */
  green:    "oklch(0.45 0.12 145)",      /* green accent */
};
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a href={href} className="text-sm font-semibold text-[var(--muted)] transition-colors hover:text-[var(--fg)]" style={{ color: C.muted } as React.CSSProperties}>
      {children}
    </a>
  );
}
