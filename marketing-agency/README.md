# Marketing Agency — Marketing Automation Platform

AI-powered marketing automation, campaign builder, and analytics dashboard.
...
This is a template project. Set it up when you're ready to build marketing automation features.
